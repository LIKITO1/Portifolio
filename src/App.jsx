  ...
  return(
    <>
      <div className="absolute w-full min-h-screen py-10 flex items-center justify-center flex-col bg-gray-800 text-white gap-4">
        ...
        <p className="w-4/5 bg-gray-700 text-center font-semibold p-4 rounded-2xl mb-6">Olá, meu nome é Lucas Santos de Oliveira e esta é uma simples página que fiz para demonstrar meus projetos pessoais</p>
